...
: 메모리에서 어떤 값을 읽으면 그 값을 1로 세팅함(원래 0이엇든 1이엇든 관계없아)

## 추상 자료형인 Semaphores를 사용한 공유자원의 lock/unlock
...
세마포어 사용 시 원치않는 문제점 : Deadlock and Starvation
